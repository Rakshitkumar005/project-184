...
def getNews():
    api_request = requests.get("https://newsapi.org/v1/articles?source=bbc-news&sortBy=top&apiKey=b4d2e1bb3e134442ab68c397bfed69d2")
    api_output_json = json.loads(api_request.content)
    
    news_title1 = api_output_json["articles"][0]["title"]
    news_description1 = api_output_json["articles"][0]["description"]
    
    news_title2 = api_output_json["articles"][2]["title"]
    news_description2 = api_output_json["articles"][2]["description"]
    
    news_title3 = api_output_json["articles"][3]["title"]
    news_description3 = api_output_json["articles"][3]["description"]
    
    news_title4 = api_output_json["articles"][5]["title"]
    news_description4 = api_output_json["articles"][5]["description"]
